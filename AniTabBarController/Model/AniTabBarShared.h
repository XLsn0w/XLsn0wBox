...
#define AniShared [AniTabBarShared shared]
...
@interface AniTabBarShared : NSObject
...
/** tabBarController */
@property (nonatomic, strong) AniTabBarController *tabBarController;
