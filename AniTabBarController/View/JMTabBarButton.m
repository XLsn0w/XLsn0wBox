...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        self.title.font = [UIFont systemFontOfSize:[AniShared titleFont]];
...
- (void)layoutSubviews {
    ...
    CGSize imageSize = [AniShared imageSize];
    CGFloat imageY = [AniShared imageOffset];
    if ([AniShared typeLayout] == JMConfigTypeLayoutImage) {
    ...
    CGFloat titleY = self.height - titleH - [AniShared titleOffset];
