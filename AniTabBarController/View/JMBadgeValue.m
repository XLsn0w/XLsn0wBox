...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        self.badgeL.textColor = [[AniTabBarShared shared] badgeTextColor];
        ...
        self.badgeL.backgroundColor = [[AniTabBarShared shared] badgeBackgroundColor];
...
- (void)setType:(JMBadgeValueType)type {
    ...
    JMConfigBadgeAnimType animType = [[AniTabBarShared shared] animType];
